...
public function index($idPeriodo, $idContrato, $idDatoContable)
{
    ...
    $pdf = Pdf::loadView('rrhh.preboleta.preboleta_pdf',compact('estaciones','tareos','num_estaciones','dia_inicio','dia_fin','num_dias','empleado','idContrato','idDatoContable','dato_contable','periodo','reintegro','bonoDeclarado'));
