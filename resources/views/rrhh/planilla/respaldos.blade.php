        ...
        @endphp
          ...
          @foreach ($estaciones as $estacion)
            <td>
              ...
              $tareo_estacion_value = $tareo_estacion->TareoPorEstacion($estacion->idEstacionDeTrabajo,$estacion->idRegimenLaboral , $dia_inicio, $dia_fin, $item->idContrato);
                      echo $tareo_estacion_value; //OJASO CON ESTO
          ...
          {{-- ... --}}
            ...
            @php
                    ...
                    $dias_descanso_programado = $descansos_programados_obj->DescansosProgramados($item->idContrato, $dia_inicio, $dia_fin);
                    ...
                    //     // Si el empleado trabajó y descansó (programado) todos los días del período, recibe su sueldo completo.
                    //     $sueldo_bruto = $sueldo_base;
                    // } else {
                    //     // Si hay faltas, se descuenta proporcionalmente.
                    //     // Se calcula el valor día sobre los días del período y se multiplica por los días justificados.
                    //     $valor_dia = $sueldo_base / $num_dias;
                    //     $sueldo_bruto = round($valor_dia * $dias_justificados, 2);
                    // }
                    $valor_dia = $sueldo_base / $num_dias;
                    $sueldo_bruto = round($valor_dia * $dias_justificados, 2);
