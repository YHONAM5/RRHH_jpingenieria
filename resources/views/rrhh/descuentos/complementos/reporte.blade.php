                            ...
                            @foreach ($otros as $item)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <button data-option="1" data-id="{{ $item->idOtrosDescuentos }}" class="btn btn-danger btn-sm btn-eliminar-descuento"><i class="fas fa-trash"></i></button>
                                        <a href="{{ route('detalles.descuento', ['idPersona' => $item->idPersona, 'idPeriodo' => $idPeriodo]) }}" class="btn btn-info btn-sm"><i class="fas fa-info-circle"></i></a>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
                        ...
                        <tbody>
                            @foreach ($prestamos as $item)
                                <tr>
                                    ...
                                    <td>{{ $item->monto }}</td>
                                    <td class="text-center">
                                        <button data-option="2" data-id="{{ $item->idPrestamo }}" class="btn btn-danger btn-sm btn-eliminar-descuento"><i class="fas fa-trash"></i></button>
                                        <a href="{{ route('detalles.descuento', ['idPersona' => $item->idPersona, 'idPeriodo' => $idPeriodo]) }}" class="btn btn-info btn-sm"><i class="fas fa-info-circle"></i></a>
                                    </td>
                                </tr>
                            @endforeach
                        ...
                        <tbody>
                            @foreach ($adelantos as $item)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <button data-option="3" data-id="{{ $item->idAdelanto }}" class="btn btn-danger btn-sm btn-eliminar-descuento"><i class="fas fa-trash"></i></button>
                                        <a href="{{ route('detalles.descuento', ['idPersona' => $item->idPersona, 'idPeriodo' => $idPeriodo]) }}" class="btn btn-info btn-sm"><i class="fas fa-info-circle"></i></a>
                                    </td>
                                </tr>
                            @endforeach
